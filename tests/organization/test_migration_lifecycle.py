...
def test_fresh_database_upgrade_heads_installs_all_visible_module_heads(
    ...
    try:
        ...
        # Alembic replaces a dependency head in the version table with the revision
        # that depends on it; the organization head remains visible in the script
        # graph and is proven installed by its schema below.
